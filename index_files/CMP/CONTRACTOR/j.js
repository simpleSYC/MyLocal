Vue.component("contractor", {
  template: `
  <div>
    <button onclick="OpenContractor();" style="float: right; border-radius: 8px; margin-right: 10%">still any quastion?? ask me now</button>
      ...
      <div class="w3-modal-content" style="padding-top: 0%">
        ...
        <div class="w3-container" style="padding-bottom: 32px">
          <div class="w3-content" style="max-width: 700px">
            ...
            <p>
              <span class="w3-tag">FYI!</span> We offer full-service catering for any event, large or small. We understand your needs and we will cater the food to satisfy the biggerst criteria of them
...
function OpenContractor() {
  let mdl = document.getElementsByClassName("w3-modal")[0];
