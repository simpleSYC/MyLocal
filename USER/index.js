...
function Load_Css() {
  let CSS_files = {
    ...
    0: "./index_files/SYT/style",
    1: "./index_files/SYT/TBL_btns",
    2: "./index_files/CMP/Input_Editor/CSS/prism",
...
function Load_Dodatok() {
  let O = {
    FILE: {
      ...
      1: "./index_files/firebase/function",
      2: "./index_files/CMP/Input_Editor/inline-edit.jquery",
      3: "./index_files/FUN/TBL_def",
      4: "./index_files/FUN/TBLA_F",
      5: "./index_files/FUN/fto",
      6: "./index_files/FUN/index",
      7: "../def",
    },
    JS: {
