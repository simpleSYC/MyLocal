...
<div style="text-align: center">
  ...
  <div style="width:29%">
    <div id="Pro_Stalaza">
      ...
      <xmp id="PRO_STATUS"> </xmp>
    </div>
  </div>


    <div style="text-align: left;width:50%;float: right;margin: 20px;">
      <button id="Service_btn">my service</button>
      <p id="CONTACTOTO_MENE" style="text-align: right"></p>
      

      <div id="bez_stalaza" style="transform: scale(1);margin-left: 25%;margin-top: -20px;display: none">
      <button id="MYALbtnC" style="display: inherit; width: 50px; height: 50px; margin: auto; border-radius: 15px; position: initial; background: azure">
    ...
    <br>
      ...
      <button id="Local_btn">my local</button>
    </div>
</div>
  `,
});
